...
namespace TaskApp.Tests.Service
{
    ...
    public class UserServiceTest {
        ...
        public void testAddUser()
        {
            ...
            mockRepository.Expects.One.MethodWith(r => r.addEntity(user1)).WillReturn(user1);
            mockRepository.Expects.One.MethodWith(r => r.addEntity(user2)).WillReturn(null);
        ...
        {
            mockRepository.Expects.One.MethodWith(r => r.getAllEntities()).WillReturn(users.AsQueryable());
            mockRepository.Expects.One.MethodWith(r => r.updateEntity(user1)).WillReturn(user1);
            mockRepository.Expects.One.MethodWith(r => r.updateEntity(user2)).WillReturn(null);
